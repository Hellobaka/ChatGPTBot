...
using me.cqp.luohuaming.ChatGPT.Core;
using me.cqp.luohuaming.ChatGPT.Core.Domain;
...
namespace me.cqp.luohuaming.ChatGPT.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.ChatGPT", 1, 9, "酷Q样例应用 for C#", "1.0.0", 1, "JieGG", "酷Q样例应用(V9应用机制)", authCode);	
